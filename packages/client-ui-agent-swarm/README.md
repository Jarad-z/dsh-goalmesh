...
details, interruption diagnostics, and child Session navigation only when the ordinary
Session list or the direct-child catalog proves the recorded parent/child lineage.
