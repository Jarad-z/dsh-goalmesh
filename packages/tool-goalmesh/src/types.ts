...
export interface GoalMeshTaskV01 {
  readonly key: string
...
export interface GoalMeshRootArgsV01 {
  readonly goal: {
    readonly statement: string
    readonly success_criteria: readonly string[]
    readonly constraints?: readonly string[]
  }
  readonly tasks: readonly GoalMeshTaskV01[]
}

export type DependencyFailurePolicy = 'fail' | 'skip' | 'partial'
export type InvocationFailureMode = 'collect_all' | 'fail_fast' | 'quorum'

export interface GoalMeshTaskV02 extends GoalMeshTaskV01 {
  readonly depends_on?: readonly string[]
  readonly dependency_failure?: DependencyFailurePolicy
}

export interface GoalMeshRootArgsV02 extends Omit<GoalMeshRootArgsV01, 'tasks'> {
  readonly tasks: readonly GoalMeshTaskV02[]
  readonly failure_mode?: InvocationFailureMode
  readonly quorum?: number
}

export interface GoalMeshNestedArgsV03 {
  readonly tasks: readonly GoalMeshTaskV02[]
  readonly failure_mode?: InvocationFailureMode
  readonly quorum?: number
}
...
export interface GoalMeshToolValue {
...
export interface RootInvocationInput {
  ...
  readonly args: GoalMeshRootArgsV02
...
export interface NestedInvocationInput {
  ...
  readonly callId: ToolRunContext['callId']
  readonly commandToken: ToolExecutionToken
  readonly args: GoalMeshNestedArgsV03
  readonly signal: AbortSignal
}
...
export interface InvocationHandle {
  readonly swarmId: SwarmId
  readonly invocationId: InvocationId
  readonly result: Promise<GoalMeshToolValue>
...
export interface GoalMeshEventMap {
  'tool-goalmesh/run-start': SwarmRunStartData
  'tool-goalmesh/invocation-start': SwarmInvocationStartData
  'tool-goalmesh/task-created': SwarmTaskCreatedData
  'tool-goalmesh/attempt-start': SwarmAttemptStartData
  'tool-goalmesh/task-transition': SwarmTaskTransitionData
  'tool-goalmesh/attempt-end': SwarmAttemptEndData
  'tool-goalmesh/invocation-end': SwarmInvocationEndData
  'tool-goalmesh/run-end': SwarmRunEndData
}

export type GoalMeshEventType = keyof GoalMeshEventMap

declare module '@deepseek-ai/dsh-session/types' {
  interface SessionEventMap extends GoalMeshEventMap {}
}
